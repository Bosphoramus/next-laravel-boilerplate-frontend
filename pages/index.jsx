...
export default function Home() {
    ...
    return (
        <>
            <Head>
                <title>Next - Laravel boilerplate</title>
            </Head>
            ...
            <div className="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
                        ...
                        <div className="flex items-center">
                            <Link href="/dashboard">
                                <div className="flex cursor-pointer">
                                    ...
                                    <a className="ml-1 text-sm text-gray-500 underline">
                                        Dashboard
                                    </a>
                                </div>
                            </Link>
                        ...
                        <div className="flex items-center">
                            <Link href="/login">
                                <div className="flex cursor-pointer">
                                    ...
                                    <a className="text-sm text-gray-500 underline ml-1">Login</a>
                                </div>
                            </Link>
                            ...
                            <Link href="/register">
                                <div className="flex cursor-pointer">
                                    ...
                                    <a className="text-sm text-gray-500 underline ml-1">Register</a>
                                </div>
                            </Link>
                        </div>
                    }
                ...
                <div className="max-w-6xl mx-auto sm:px-6 lg:px-8">
                    <div className="flex justify-center pt-12 sm:pt-8 sm:justify-start">
                        <svg
                            viewBox="0 0 651 192"
                            fill="none"
